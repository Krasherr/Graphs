...
bool MaximumIndependentSet::removable(std::vector<int> neighbor, std::vector<int> cover)
{
    bool check=true;
...
int MaximumIndependentSet::max_removable(std::vector<std::vector<int> > neighbors, std::vector<int> cover)
{
    int r=-1, max=-1;
...
vector<int> MaximumIndependentSet::procedure_1(std::vector<vector<int> > neighbors, std::vector<int> cover)
{
...
vector<int> MaximumIndependentSet::procedure_2(std::vector<std::vector<int> > neighbors, std::vector<int> cover, int k)
{
    int count=0;
    vector<int> temp_cover=cover;
    int i=0;
...
int MaximumIndependentSet::cover_size(std::vector<int> cover)
{
    int count=0;
    for(int i=0; i<cover.size(); i++)
        if(cover[i]==1) count++;
...
vector<int> MaximumIndependentSet::process(std::vector<vector <int> > graph, int V, int z, ofstream& outfile)
{
